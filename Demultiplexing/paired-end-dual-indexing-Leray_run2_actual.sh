...
###############################################
mkdir /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Lerayrun2_v2

Output="/Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Lerayrun2_v2"
DATADIR="/Users/stephaniematthews/Documents/P1604/Allen/Allen_Stephanie-175088914/FASTQ_Generation_2020-06-25_18_26_52Z-271138419/leray"
 
for i in ~/Documents/P1604/Allen/Allen_Stephanie-175088914/FASTQ_Generation_2020-06-25_18_26_52Z-271138419/leray/S*/S*_R1_001.fastq.gz
do
R1=$i;
R2=${R1//_R1_/_R2_};
...
done<~/Documents/P1604/Allen/leray_run2_6mer_demultiplex.txt > $Output/$SAMPLE/summary.txt
...
Output="Results"
for i in /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Lerayrun2_v2/*/summary.txt
do
New_summary=${i%.txt}.csv;
python /Users/stephaniematthews/Documents/P1604/Allen/cutadapt_parser_steph.py -i $i -o $New_summary
done

###############################################
# This is for collecting the second row of each trimmed summary file into one table

for i in /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Lerayrun2_v2/*/*.csv
do
sed -n '2p' $i
done > /Users/stephaniematthews/Documents/P1604/Allen/Overall_summary_leray_run2.csv
###############################################
