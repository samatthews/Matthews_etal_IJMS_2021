...
###############################################
mkdir /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Zhanrun1

Output="/Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Zhanrun1"
DATADIR="/Users/stephaniematthews/Documents/P1604/Allen/Sommer_020819-118427309/FASTQ_Generation_2019-02-11_11_16_49Z-160020829/zhan"
 
for i in /Users/stephaniematthews/Documents/P1604/Allen/Sommer_020819-118427309/FASTQ_Generation_2019-02-11_11_16_49Z-160020829/zhan/S*/S*_R1_001.fastq.gz
do
R1=$i;
R2=${R1//_R1_/_R2_};
...
done<~/Documents/P1604/Allen/zhan_run1_6mer_demultiplex.txt > $Output/$SAMPLE/summary.txt
...
do
sed -n '2p' $i
done > /Users/stephaniematthews/Documents/P1604/Allen/Overall_summary_zhan_run1.csv
###############################################
