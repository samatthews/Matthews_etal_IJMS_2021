...
###############################################
mkdir /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Zhanrun2_v2

Output="/Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Zhanrun2_v2"
DATADIR="/Users/stephaniematthews/Documents/P1604/Allen/Allen_Stephanie-175088914/FASTQ_Generation_2020-06-25_18_26_52Z-271138419/zhan"
 
for i in ~/Documents/P1604/Allen/Allen_Stephanie-175088914/FASTQ_Generation_2020-06-25_18_26_52Z-271138419/zhan/S*/S*_R1_001.fastq.gz
do
R1=$i;
R2=${R1//_R1_/_R2_};
...
done<~/Documents/P1604/Allen/zhan_run2_6mer_demultiplex.txt > $Output/$SAMPLE/summary.txt
...
#Output="Results"
for i in /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Zhanrun2_v2/*/summary.txt
do
...
for i in /Users/stephaniematthews/Documents/Chapter1/demultiplexed_data/Zhanrun2_v2/*/*.csv
do
sed -n '2p' $i
done > /Users/stephaniematthews/Documents/P1604/Allen/Overall_summary_zhan_run2.csv
###############################################
